<x-app-layout><x-slot name="header"><h2 class="text-3xl font-extrabold leading-tight text-gray-800">{{ __('🗑️ Papelera de Usuarios Eliminados') }}</h2></x-slot><div class="py-12">
            ...
            <div class="overflow-x-auto rounded-lg shadow-md">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-blue-100/70">
                        <tr>
                            <th class="px-6 py-3 text-xs font-semibold tracking-wider text-left text-blue-700 uppercase">Nombre</th>
                            <th class="px-6 py-3 text-xs font-semibold tracking-wider text-left text-blue-700 uppercase">Email</th>
                            <th class="px-6 py-3 text-xs font-semibold tracking-wider text-left text-blue-700 uppercase">Rol</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        @forelse ($users as $user)
                            <tr class="transition duration-100 ease-in-out hover:bg-red-50">
                                ...
                                <td class="px-6 py-4 text-sm font-medium text-gray-900">{{ ucfirst($user->role) }}</td>
