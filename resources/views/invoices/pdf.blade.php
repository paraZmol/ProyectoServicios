            ...
            <tr>
                <td width="25%">
                    @if (isset($setting->logo_path) && $setting->logo_path)
                        ...
                        >
                    @else
                        <h2 style="margin: 0; font-size: 18px;">{{ $setting->nombre_empresa ?? 'PROYECTO SERVICIOS S.A.' }}</h2>
                    @endif
                </td>

                <td width="50%" class="company-info">
                    <p style="font-size: 16px; font-weight: bold; margin-bottom: 5px;">{{ $setting->nombre_empresa ?? 'PROYECTO SERVICIOS S.A.' }}</p>
