<x-app-layout>
    <x-slot name="header">
        <h2 class="text-3xl font-extrabold leading-tight text-gray-800">
            {{ __('🗑️ Papelera de Boletas Eliminadas') }}
        </h2>
    </x-slot>
                ...
                <div class="overflow-x-auto rounded-lg shadow-md">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-blue-100/70">
                            <tr>
                                <th class="px-6 py-3 text-xs font-semibold tracking-wider text-left text-[#1E3A8A] uppercase">Boleta N°</th>
                            ...
                            @forelse ($invoices as $invoice)
                                <tr class="transition duration-100 ease-in-out hover:bg-red-50">
                                    ...
                                    <td class="flex justify-center px-6 py-4 space-x-3 text-sm font-medium whitespace-nowrap">
                                        ...
                                        {{-- eliminar permanentemente (boton modal) --}}
                                        <button type="button"
                                            onclick="openDeleteModal('{{ route('invoices.forceDelete', $invoice->id) }}')"
                    ...
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-xl font-bold leading-6 text-gray-900" id="modal-title">
                                Eliminar Boleta Definitivamente
                            </h3>
                            <div class="mt-3">
                                <p class="text-sm text-gray-500">
                                    ¿Estás seguro de que deseas destruir este registro fiscal?
                                </p>
                                <div class="p-3 mt-4 border-l-4 border-red-500 rounded-lg bg-red-50">
                                    <p class="text-xs font-semibold text-red-700">
                                        ⚠️ IMPORTANTE: ACCIÓN DESTRUCTIVA
                                    </p>
                                    <p class="mt-1 text-xs text-red-600">
                                        Esta acción eliminará por completo la boleta y sus detalles de la base de datos.
                                    </p>
                                </div>
                            </div>
                        </div>
