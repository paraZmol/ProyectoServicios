    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="p-6 overflow-hidden bg-white shadow-sm sm:rounded-lg">
                ...
                {{-- nota: el atributo 'enctype' es esencial para la subida de archivos (logo) --}}
                <form method="POST" action="{{ route('settings.update') }}" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                        ...
                        {{-- logo y general en la parte isquierda --}}
                        <div class="space-y-6">
                            <h3 class="pb-2 mb-4 text-lg font-semibold border-b">{{ __('Información General') }}</h3>
                            ...
                            {{-- simbolo de moneda --}}
                            <div>
                                <x-input-label for="simbolo_moneda" :value="__('Símbolo de moneda')" />
                        ...
                        <div class="space-y-6">
                            <h3 class="pb-2 mb-4 text-lg font-semibold border-b">{{ __('Contacto y Ubicación') }}</h3>
                            ...
                            {{-- region / provincia --}}
                            <div>
                                <x-input-label for="region_provincia" :value="__('Región/Provincia')" />
                                <x-text-input id="region_provincia" name="region_provincia" type="text" class="block w-full mt-1" :value="old('region_provincia', $setting->region_provincia)" />
                                <x-input-error class="mt-2" :messages="$errors->get('region_provincia')" />
                            </div>
